...
from Kinetics_dataset import KineticsDataset, KineticsDataset_modality_level
import warnings
import json
import logging
        ...
        if use_augmentation and label is not None:
            ...
            if current_epoch < self.warmup_epochs:
                ...
                if uni_ratio > 1:
                    ...
                    mm_ratio_1 = mixed_video_prob.detach().mean() / mixed_audio_prob.detach().mean()
                ...
                if uni_ratio > 1:
                    ...
                    mm_ratio_2 = mixed_video_prob.detach().mean() / mixed_audio_prob.detach().mean()
...
class MidasModel(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_nb):
        ...
        acc = FM.accuracy(preds, batch["label"], task="multiclass", num_classes=self.hparams.get("num_classes", 31))
    ...
    def test_step(self, batch):
        ...
        acc = FM.accuracy(preds, labels, task="multiclass", num_classes=31)
        f1 = FM.f1_score(preds, labels, task="multiclass", num_classes=31, average="macro")
    ...
    def test(self, dataloader):
        ...
        # 최종 정확도 계산
        test_acc = FM.accuracy(all_preds, all_labels, task="multiclass", num_classes=31)
    ...
    def _build_model(self):
        ...
        return AudioAndVisionModel(
            num_classes=self.hparams.get("num_classes", 31),
    ...
    def save_records(self, seed):
        ...
        filename = "save_records/kinetics_record_" + method + "_" + str(seed) + ".json"
        contributions = [
            {
                "epoch": i,
            ...
            for i in range(len(self.val_swapped_acc))
        ]
